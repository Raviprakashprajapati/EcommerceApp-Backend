...
import { searchAllCount, searchByBetPrice, searchGetAllProduct, searchProductByAny, searchProductByBar, searchProductByReq, searchProductBy_clothing, searchProductBy_eletronics } from "../controllers/search.controller.js";
...
router.route("/search/price").post(searchByBetPrice)
